...
namespace App\Facades { 
    ...
    class EasySmsFacade {
         ...
         * @static 
         */ 
        public static function send($to, $message, $gateways = [])
        {
                        /** @var \Overtrue\EasySms\EasySms $instance */
                        return $instance->send($to, $message, $gateways);
        }
         ...
         * @static 
         */ 
        public static function strategy($strategy = null)
        {
                        /** @var \Overtrue\EasySms\EasySms $instance */
...
namespace  { 
    ...
    class SMS extends \App\Facades\EasySmsFacade {}

    class Warning extends \App\Facades\WarningFacade {}
